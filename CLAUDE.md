...
**YOU ARE IN: `quick_capture/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/quick_capture/` (rig root) or other directories
...
**Your mail address:** `quick_capture/polecats/chrome`
**Your rig:** quick_capture
**Your Witness:** `quick_capture/witness`
...
| Ask Witness for help | `gt mail send quick_capture/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`quick_capture/witness`) when:
...
```bash
gt mail send quick_capture/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
